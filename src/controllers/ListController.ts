...
export class ListController {
    ...
    get guestListFind() {
        return asyncHandler(async(req:Request, res:Response, next:NextFunction) => {
           const guestList = await this.listModel.guestList(req.params, req.user as UserEntity );
            new OkResponse(res, {guestList});
        })
    }

    get guestListFindOne() {
        return asyncHandler(async(req:Request, res:Response, next:NextFunction) => {
           const guestList = await this.listModel.guestOneList(req.params, req.user as UserEntity );
            new OkResponse(res, {guestList});
        })
    }
